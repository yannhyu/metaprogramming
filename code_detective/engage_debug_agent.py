...
# using code to manipulate code
# achieve DRY by autopilot repetitive things
# decoupling of debugger from code target

from debug_agent import debug, debugargs, debugmethods, debugattr, debugmeta
